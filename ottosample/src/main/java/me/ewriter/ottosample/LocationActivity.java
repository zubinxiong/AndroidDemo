...
public class LocationActivity extends FragmentActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.clear_location).setOnClickListener(new OnClickListener() {
      @Override public void onClick(View v) {
        ...
        Log.d(TAG, "onclick clear_location, post LocationClearEvent");
        ...
        Log.d(TAG, "onclick clear_location, post produceLocationEvent");
        // 清除位置也是发送 LocationChangedEvent,上面先调用了clear
    ...
    findViewById(R.id.move_location).setOnClickListener(new OnClickListener() {
      @Override public void onClick(View v) {
        ...
        Log.d(TAG, "onclick move_location, post produceLocationEvent");
        BusProvider.getInstance().post(produceLocationEvent());
      }
    });
  }
  ...
  @Produce public LocationChangedEvent produceLocationEvent() {
    ...
    // produce 每次都返回LocationEvent 这个事件，Subscribe了这个事件都会接收到
    Log.d(TAG, "produce produceLocationEvent");
