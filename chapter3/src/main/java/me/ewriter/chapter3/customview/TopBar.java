...
public class TopBar extends RelativeLayout {
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        // 通过这个方法，将你在attrs.xml 中定义的declare-styleable 的所有属性取到TypeArrary中
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.TopBar);

        // 从TypedArray 中取出对应的值来为要设置的属性赋值
        ...
        // title和titleTextColor 属性被系统使用了，因此这个地方相比书上改了名字
        ...
        // 获取完TypedArray 的值后，一般要调用recycle方法来避免重新创建的时候的错误
        ta.recycle();
