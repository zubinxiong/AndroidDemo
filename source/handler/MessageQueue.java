 ...
 * MessageQueue 并没有把Message 直接添加到MessageQueue 中，而是只使用了一个mMessages对象
 * 表示当前待处理的消息
 */
public final class MessageQueue {
	...
	// 这里的入队实际就是将所有的消息按照时间来排序，这个时间就是我们在sendMessageAtTime 】
	// 里面的第二个参数uptimeMillis,具体就是根据时间从小到大的顺序调用msg.next， 从而知道下
	// 一个消息是什么
